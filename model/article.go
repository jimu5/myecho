...
const (
	ArticleContentFormatMarkdown ArticleContentFormat = "markdown"
	ArticleContentFormatHTML     ArticleContentFormat = "html"
)

func NormalizeArticleContentFormat(format ArticleContentFormat) ArticleContentFormat {
	if format == "" {
		return ArticleContentFormatMarkdown
	}
	return format
}

func IsValidArticleContentFormat(format ArticleContentFormat) bool {
	format = NormalizeArticleContentFormat(format)
	return format == ArticleContentFormatMarkdown || format == ArticleContentFormatHTML
}
